    ...
    client
      ...
      .perform(function(client, done) {
        ...
        client
          .url(
            `${client.globals
              .baseUrl}/kew/DocHandler.do?command=displayDocSearchView&docId=${documentNumber}`
          )
          ...
          .getText('#awardIdAccount', function(result) {
            ...
            transactionTabNumber =
              'methodToCall.toggleTab.tabTransactions' +
              awardNumber +
              hierarchyNumber
            transactionAdd =
              'methodToCall.addTransaction.anchorTransactions' +
              awardNumber +
              hierarchyNumber
          })
          .perform(function(client, done) {
            client
              .setValue(
                'input[id="awardHierarchyNodeItems[1].currentFundEffectiveDate"]',
                '04/01/2014'
              )
              .setValue(
                'input[id="awardHierarchyNodeItems[1].obligationExpirationDate"]',
                '04/30/2017'
              )
              // Adding transactions
              .click(`input[name="${transactionTabNumber}"]`)
              .click(
                'select[id="transactionBean.newPendingTransaction.sourceAwardNumber"] option[value="000000-00000"]'
              )
              .click(
                `select[id="transactionBean.newPendingTransaction.destinationAwardNumber"] option[value="${awardIdAccount}"]`
              )
              .clearValue(
                'input[id="transactionBean.newPendingTransaction.obligatedAmount"]'
              )
              .setValue(
                'input[id="transactionBean.newPendingTransaction.obligatedAmount"]',
                '100000.00'
              ...
              .clearValue(
                'input[id="transactionBean.newPendingTransaction.anticipatedAmount"]'
              )
              .setValue(
                'input[id="transactionBean.newPendingTransaction.anticipatedAmount"]',
                '100000.00'
              ...
              .pause(1000)
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.reload.navigateTo.budgets"]'
              )
              .setValue(
                'input[name="newBudgetVersionName"]',
                'Award Budget AFT'
              )
              .click('input[name="methodToCall.addBudgetVersion"]')
              .pause(1000)
              .sendKeys(
                'input[name="methodToCall.openBudgetVersion.line0"]',
                client.Keys.ENTER
              )
              .waitForElementVisible(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.parameters"]',
                3000
              )
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.parameters"]'
              ...
              .pause(1000)
              .clearValue(
                'input[id="document.budget.budgetPeriods[0].directCostLimit"]'
              )
              .setValue(
                'input[id="document.budget.budgetPeriods[0].directCostLimit"]',
                '25000.00'
              ...
              .clearValue(
                'input[id="document.budget.budgetPeriods[1].directCostLimit"]'
              )
              .setValue(
                'input[id="document.budget.budgetPeriods[1].directCostLimit"]',
                '25000.00'
              ...
              .clearValue(
                'input[id="document.budget.budgetPeriods[2].directCostLimit"]'
              )
              .setValue(
                'input[id="document.budget.budgetPeriods[2].directCostLimit"]',
                '25000.00'
              ...
              .clearValue(
                'input[id="document.budget.budgetPeriods[3].directCostLimit"]'
              )
              .setValue(
                'input[id="document.budget.budgetPeriods[3].directCostLimit"]',
                '25000.00'
              ...
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.expenses"]'
              )
              .pause(1000)
              ...
              .click(
                'select[name="newBudgetLineItems[0].costElement"] option[value="421818"]'
              )
              .clearValue('input[id="newBudgetLineItems[0].lineItemCost"]')
              .setValue(
                'input[id="newBudgetLineItems[0].lineItemCost"]',
                '5000.00'
              )
              .click(
                'input[name="methodToCall.addBudgetLineItem.budgetCategoryTypeCodeE.catTypeIndex0.anchorEquipment"]'
              )
              .click('input[name="methodToCall.showAllTabs"]')
              .click(
                'select[name="newBudgetLineItems[2].costElement"] option[value="420333"]'
              )
              .clearValue('input[id="newBudgetLineItems[2].lineItemCost"]')
              .setValue(
                'input[id="newBudgetLineItems[2].lineItemCost"]',
                '5000.00'
              )
              .click(
                'input[name="methodToCall.addBudgetLineItem.budgetCategoryTypeCodeS.catTypeIndex2.anchorParticipantSupport"]'
              )
              ...
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.personnel"]'
              )
              .pause(3000)
              ...
              .click('input[name="methodToCall.showAllTabs"]')
              .waitForElementVisible(
                'input[name="document.budget.budgetPersons[0].calculationBase"]',
                1000
              )
              .clearValue(
                'input[name="document.budget.budgetPersons[0].calculationBase"]'
              ...
              .pause(1000)
              .clearValue(
                'input[name="document.budget.budgetPersons[1].calculationBase"]'
              )
              .setValue(
                'input[name="document.budget.budgetPersons[1].calculationBase"]',
                '5000'
              ...
              .click('input[name="methodToCall.showAllTabs"]')
              .click(
                'select[name="newBudgetPersonnelDetails.personSequenceNumber"] option[value="1"]'
              )
              .click(
                'select[name="newBudgetLineItems[0].costElement"] option[value="400250"]'
              )
              .click('.addButton')
              .pause(1000)
              .click('input[name="methodToCall.showAllTabs"]')
              .pause(3000)
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriod[0].budgetLineItem[0].budgetPersonnelDetailsList[0].percentEffort"]',
                1000
              )
              .clearValue(
                'input[id="document.budget.budgetPeriod[0].budgetLineItem[0].budgetPersonnelDetailsList[0].percentEffort"]'
              ...
              .pause(1000)
              .waitForElementVisible(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[0].budgetPersonnelDetailsList[0].percentCharged"]',
                1000
              )
              .clearValue(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[0].budgetPersonnelDetailsList[0].percentCharged"]'
              ...
              // disable inflation
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].applyInRateFlag"]',
                1000
              )
              .sendKeys(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].applyInRateFlag"]',
              ...
              // disable la rates
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[1].applyRateFlag"]',
                1000
              )
              .sendKeys(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[1].applyRateFlag"]',
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[2].applyRateFlag"]',
                1000
              )
              .sendKeys(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[2].applyRateFlag"]',
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[3].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[4].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[5].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[0].budgetLineItemCalculatedAmounts[0].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .click('input[name="methodToCall.showAllTabs"]')
              .waitForElementVisible(
                'input[name^="methodToCall.applyToLaterPeriods.line0"]',
                1000
              )
              .sendKeys(
                'input[name^="methodToCall.applyToLaterPeriods.line0"]',
              ...
              .click(
                'select[name="newBudgetPersonnelDetails.personSequenceNumber"] option[value="2"]'
              )
              .click(
                'select[name="newBudgetLineItems[0].costElement"] option[value="400025"]'
              )
              .click('.addButton')
              .waitForElementVisible(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[2].budgetPersonnelDetailsList[0].percentEffort"]',
                1000
              )
              .clearValue(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[2].budgetPersonnelDetailsList[0].percentEffort"]'
              ...
              .pause(1000)
              .waitForElementVisible(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[2].budgetPersonnelDetailsList[0].percentCharged"]',
                1000
              )
              .clearValue(
                'input[name="document.budget.budgetPeriod[0].budgetLineItem[2].budgetPersonnelDetailsList[0].percentCharged"]'
              ...
              .click('input[name="methodToCall.showAllTabs"]')
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].applyInRateFlag"]',
                1000
              )
              .sendKeys(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].applyInRateFlag"]',
              ...
              // disable la rates
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].budgetLineItemCalculatedAmounts[1].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].budgetLineItemCalculatedAmounts[2].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].budgetLineItemCalculatedAmounts[3].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].budgetLineItemCalculatedAmounts[4].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .waitForElementVisible(
                'input[id="document.budget.budgetPeriods[0].budgetLineItems[2].budgetLineItemCalculatedAmounts[0].applyRateFlag"]',
                1000
              )
              .pause(1000)
              .sendKeys(
              ...
              .click('input[name="methodToCall.showAllTabs"]')
              .waitForElementVisible(
                'input[name^="methodToCall.applyToLaterPeriods.line2"]',
                1000
              )
              .sendKeys(
                'input[name^="methodToCall.applyToLaterPeriods.line2"]',
              ...
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.summaryTotals"]'
              )
              .pause(1000)
              .clearValue(
                'input[name="document.budget.budgetPeriods[0].totalFringeAmount"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[0].totalFringeAmount"]',
                '771.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[1].totalFringeAmount"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[1].totalFringeAmount"]',
                '653.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[2].totalFringeAmount"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[2].totalFringeAmount"]',
                '653.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[3].totalFringeAmount"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[3].totalFringeAmount"]',
                '480.25'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[0].totalIndirectCost"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[0].totalIndirectCost"]',
                '4229.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[1].totalIndirectCost"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[1].totalIndirectCost"]',
                '4347.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[2].totalIndirectCost"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[2].totalIndirectCost"]',
                '4347.00'
              ...
              .clearValue(
                'input[name="document.budget.budgetPeriods[3].totalIndirectCost"]'
              )
              .setValue(
                'input[name="document.budget.budgetPeriods[3].totalIndirectCost"]',
                '13686.41'
              ...
              .pause(1000)
              .click(
                'input[name="methodToCall.headerTab.headerDispatch.save.navigateTo.budgetActions"]'
              )
              .click('input[name="methodToCall.route"]')
              .pause(1000)
              .url(
                `${client.globals
                  .baseUrl}/kew/DocHandler.do?command=displayDocSearchView&docId=${budgetDocumentNumber}`
              )
              .element('css selector', '[id=Rice-LoginButton]', function(
                result
              ) {
                if (result.status != -1) {
                  client.setValue('input[type=text]', 'quickstart')
              ...
              .getText('#awardBudgetStatus', function(result) {
                ...
                assert(
                  budgetStatus === 'Submitted' ||
                    budgetStatus === 'To Be Posted'
                )
              })
            done()
          })
        done()
        // check that award doc can be versioned
        client
          .url(
            `${client.globals
              .baseUrl}/kew/DocHandler.do?command=displayDocSearchView&docId=${documentNumber}`
          ...
          .waitForElementVisible(
            'input[name="methodToCall.editOrVersion"]',
            3000
          )
          .click('input[name="methodToCall.editOrVersion"]')
          .waitForElementVisible('input[name="methodToCall.save"]', 3000)
          .url(
            `${client.globals
              .baseUrl}/kew/DocHandler.do?command=displayDocSearchView&docId=${documentNumber}`
          )
          ...
          .click('input[name="methodToCall.editOrVersion"]')
          .waitForElementVisible(
            '#kualiForm > table > tbody > tr > td:nth-child(2) > div:nth-child(11)',
            3000
          )
      })
  }
